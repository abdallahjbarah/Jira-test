...
export const useFetchAvailabilitySlots = (
    ...
    queryOptions?: Omit<UseQueryOptions<
        ...
        Error,
        AvailabilitiesSlotsResponse,
        readonly ['availabilitySlots', string, number | undefined, number | undefined]
    >, 'queryKey' | 'queryFn' | 'enabled'>,
) => {
    return useQuery({
        ...queryOptions,
        queryKey: ['availabilitySlots', params.siteId, params.startDateTime, params.endDateTime] as const,
