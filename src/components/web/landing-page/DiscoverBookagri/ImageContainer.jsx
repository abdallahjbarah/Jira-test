    ...
    <CustomLink className={"group"} path={path || '#'}>
      ...
      >
        ...
        <div className='absolute top-[2.5rem] left-[2.5rem]'>
          ...
          <div className=' flex gap-2 items-center text-custom-24 font-custom-400 text-primary_4 group-hover:text-primary_2 transition-all duration-200'>
            <span>View All</span>
            <ArrowRight className='transition-all fill-primary_4 group-hover:fill-primary_2 group-hover:translate-x-2' />
          </div>
        </div>
      </div>
    </CustomLink>
