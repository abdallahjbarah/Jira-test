...
type ShapeType = keyof typeof SHAPE_STYLES;
...
export default function PasswordInput({
  ...
  const focusClass = withFocus
    ...
    : 'outline-none';
  const shapeClass = shape ? SHAPE_STYLES[shape] : SHAPE_STYLES[1];
  ...
  return (
    <div className='relative'>
      ...
      <input
        ...
        value={value}
        className={`${shapeClass} ${disabledClass} ${focusClass} ${className}`}
