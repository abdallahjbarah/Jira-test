        ...
        <main className="relative flex min-h-screen flex-col items-center bg-white px-4">
            ...
            <div className="mt-52 w-full max-w-sm space-y-8 px-4 sm:max-w-md">
                ...
                <div className="flex items-center justify-center gap-2">
                    <h1 className="text-[#222222] text-[32px] leading-[32px] font-bold">Welcome to</h1>
                    <Image
                            ...
                            <Form className="space-y-4">
                                <div>
                                    <input
                                        ...
                                        onBlur={handleBlur}
                                        className="w-full rounded-lg border border-gray-200 bg-white px-4 py-3 text-gray-700 placeholder:font-light placeholder:text-[#555555] focus:border-primary_1 focus:outline-none focus:ring-1 focus:ring-primary_1"
                                    />
