        ...
        <main className="relative flex min-h-screen flex-col items-center bg-white px-4">
            ...
            <div className="mt-52 w-full max-w-sm space-y-8 px-4 sm:max-w-md">
                ...
                <div className="flex items-center justify-center whitespace-nowrap">
                    <h1 className="text-[#222222] text-[32px] leading-[32px] font-bold">Forgot Your&nbsp;</h1>
                                ...
                                <div className="space-y-1">
                                    <div className="relative">
                                        <input
                                            ...
                                            onBlur={handleBlur}
                                            className={`w-full rounded-lg border ${touched.email && errors.email ? 'border-red-500' : 'border-gray-200'
