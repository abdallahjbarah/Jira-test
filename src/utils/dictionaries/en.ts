const en = {
  ...
  bookingStatus: {
    ...
    cancellationSuccess: {
      ...
      emailNote:
        "If you didn't receive an email, please check your spam or junk folder.",
      action: 'Ok, got it',
  ...
  booking: {
    ...
    success: {
      ...
      description:
        "We'll review it shortly, and once confirmed, you'll be all set for your agri-stay.",
      emailNote:
        "If you didn't receive an email, please check your spam or junk folder.",
      viewBooking: 'Got it',
    },
    ...
    AttachTheFinancialReceipt: 'Attach the financial receipt',
    Submit: 'Submit',
  },
  search: {
    'check-in': 'Check-in',
  ...
  similarExperiences: {
    ...
    ifYouEnjoyedThis: 'If you enjoyed this, you might also like',
  },
  stayDetails: {
    stayDetails: 'Stay Details',
  },
  nearbySurroundings: {
    nearbySurroundings: 'Nearby & Surroundings',
  },
  houseRules: {
    houseRules: 'House Rules',
  },
  completeYourBooking: {
    completeYourBookingAndPay: 'Complete your booking and pay',
    thingsToKnow: 'Things to Know',
    stayNearby: 'Stay Nearby',
    stayHouseRules: 'Stay House Rules',
    cancellationPolicy: 'Cancellation Policy',
    guide: 'Guide',
